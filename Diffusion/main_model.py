...
class CSDI_Sgra(CSDI_base):
    def __init__(self, config, device, gp_noise=False, gp_sigma=None, target_dim=4):
        super(CSDI_Sgra, self).__init__(target_dim, config, device, gp_noise, gp_sigma)
...
class CSDI_Walk(CSDI_base):
    def __init__(self, config, device, gp_noise=False, gp_sigma=None, target_dim=1):
        super(CSDI_Walk, self).__init__(target_dim, config, device, gp_noise, gp_sigma)
